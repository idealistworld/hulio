...
const mainButtons = `<button onclick="location.href = 'https://youtube.com';" id="action-button1" class="fifth" onclick="location.href = 'https://youtube.com';"> Download </button> <button id="action-button2" class="fifth" onclick="howItWorks()">How it Works</button></div>`;
const arrayNavButtons = `<div style = "width: 40%;"><button id="action-button2" class="fifth nav" onclick="prev()">Previous</button> <button id="action-button2" class="fifth nav" onclick="next()">Continue</button>`;
...
const actionButtons = `<div id="action-button"> <button id="action-button1" class="fifth" onclick="location.href = 'https://chrome.google.com/webstore/detail/honey-automatic-coupons-r/bmnlcjabgnpnenekpadlanbbkooimhnj';"> Download </button> <button id="action-button2" class="fifth" onclick="howItWorks()"> How it Works </button> </div>`;
const infoLinks = `<div style = "width: 80%;"><button id="action-button2" class="fifth nav" onclick="prev()">Pitch Deck</button> <button id="action-button2" class="fifth nav" onclick="next()">Pitch Video</button>`;
